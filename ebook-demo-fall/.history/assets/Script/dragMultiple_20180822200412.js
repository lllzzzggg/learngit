        ...
        grooves.map(groove => {
            ...
            if(node.parentBox){
                ...
                if(index == -1){
                    ...
                    let correct_nodes = cc.sys.localStorage.getItem(`${self.data.game}correct_nodes`) || ''
                    correct_nodes += `|${node.originIndex}_${num}`
                    cc.sys.localStorage.setItem('correct_nodes', correct_nodes)
                    //保留拖拽正确的选项
                }
            }
        })
