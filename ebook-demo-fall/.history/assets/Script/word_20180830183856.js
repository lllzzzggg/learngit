        ...
        if(score != null){
            ...
            if(score > 0){
                ...
                cc.sys.localStorage.setItem('openTime', (+openTime + 1));
                 ...
                 let openTime = cc.sys.localStorage.getItem('readTime') || 0;
                 cc.sys.localStorage.setItem('readTime', (+openTime + 1));
                //统计完成率
                let finishTime = cc.sys.localStorage.getItem('finishTime') || 0;
                cc.sys.localStorage.setItem('finishTime', (+finishTime + 1));
            }else{
                let openTime = cc.sys.localStorage.getItem('wrongTime') || 0;
                cc.sys.localStorage.setItem('wrongTime', (+openTime + 1));
            }
