cc.Class({
    ...
    gameOverForData: function(totalTime, isSucceed)
    {
        var question = this.questionArr[this.nowQuestionID];
        var aStatus = isSucceed?1:0;
        //组装数据
        var answerInfo = {
            answerTime: totalTime,
            leveLQuestionDetailNum: question.leveLQuestionDetailNum,
            levelQuestionDetailID: question.levelQuestionDetailID,
            answerStatus: aStatus,
            answerContext: "",
        };
        this.answerInfoArr.push(answerInfo);
        // console.log("baseGamejs game OVER");
        this.network.gameOver(totalTime, this.answerInfoArr)
        // console.log(totalTime);
        // console.log(this.answerInfoArr);
    },
    //倒计时回调
