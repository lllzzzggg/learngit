...
cc.Class({
    ...
    initPage(data,right,audio,url,pageName,time){
        let self = this;
        if(data){
            self.data = data;
    ...
    bindSelect(){
        ...
        let choice_listen = select.parent.parent.getComponent('choice_listen')
            ...
            select.on('touchend',()=>{
                ...
                if(self.data === self.right){
                    ...
                    for(let i = 0;i<children.length;i++){
                        let page_js = children[i].getComponent('select');
    ...
    reviewSubmit(){
        ...
        self.scheduleOnce(()=>{
            ...
            for(let i = 0;i<selects.length;i++){
                ...
                if(selects[i].getChildByName("word").getChildByName("text").getComponent(cc.Label).string === self.right){   
