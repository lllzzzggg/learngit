cc.Class({
    ...
    initGame(pages) {
        ...
        if (pages) {
            ...
            // cc.sys.localStorage.setItem('HOST', 'http://10.32.31.51/resources/')  //本地测试地址
    ...
    loadAudios() {
        ...
        le t xhr = cc.loader.getXMLHttpRequest();
    ...
    transition(nodeIn, nodeOut, next) {
        ...
        if (nodeIn.moduleName === 'drag_multiple' || nodeIn.moduleName === 'drag'){
