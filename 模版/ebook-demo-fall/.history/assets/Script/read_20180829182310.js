cc.Class({
    ...
    touendEvent() {
        ...
        let texts = cc.find('mask/texts', self.node);
    ...
    initLabel() {
        ...
        let writes_node = cc.find('mask/texts/writes', self.node)
        let pages_node = cc.find('mask/texts/pages', self.node)
    ...
    activePageDot(){
        let self = this
        let pages = cc.find('mask/texts/pages', self.node)
    ...
    bindSlideAction(){
        ...
        texts.on(cc.Node.EventType.TOUCH_MOVE, event => {
            ...
            let write_node = cc.find('writes',texts)
    ...
    initWords() {
        ...
        if (words && words.length !== 0) {
            ...
            for (let i = 0; i < words.length; i++) {
                ...
                word_pane.x = 175 + 350*(i%2)
                word_pane.y = -50 - 100 * Math.floor(i/ 2);
