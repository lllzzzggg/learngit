cc.Class({
    ...
    touendEvent() {
        ...
        let texts = cc.find('texts', self.node).children;
        ...
        up.cleanup();
        self.write(write_node,write_str);
    },
    cancelWrite() {
        let self = this;
        cc.audioEngine.stopAll();
    ...
    write(node, str) {
        ...
        let up = cc.find('text/up_text', node);
        ...
        let str = self.initLabel(self.configData["texts"][0].read_text);
    ...
    initLabel() {
        ...
        let texts_node = cc.find('texts', self.node)
        texts_node.cleanup()
        for(let i = 0;i<strArr.length;i++){
            ...
            texts_node.addChild(write_node)
